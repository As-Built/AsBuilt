        ...
        security.cors(Customizer.withDefaults())
            ...
            .authorizeHttpRequests { requests ->
                requests
                    ...
                    .requestMatchers(mvc.pattern(HttpMethod.POST, "/users/grantRole/**")).permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.PATCH, "/users/updateUser")).permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.PATCH, "/users/updateSystemLanguage")).permitAll()
                    ...
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/productionValue/**")).permitAll()
                    .requestMatchers(mvc.pattern(HttpMethod.POST, "/salary/**")).hasAnyRole("ADMIN", "CONFERENTE")
                    .requestMatchers(mvc.pattern(HttpMethod.GET, "/salary/**")).permitAll()
